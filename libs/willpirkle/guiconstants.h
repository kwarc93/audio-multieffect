...
*/
const float kCTCoefficient = 5.0 / 12.0;
...
*/
const float kCTCorrFactorZero = pow(10.0, (-1.0/kCTCoefficient));
...
*/
const float kCTCorrFactorAnitZero = 1.0 / (1.0 - kCTCorrFactorZero);
...
*/
const float kCTCorrFactorUnity = 1.0 / (1.0 + kCTCoefficient*log10(1.0 + kCTCorrFactorZero));
...
*/
const float kCTCorrFactorAntiUnity = 1.0 / (1.0 + (-pow(10.0, (-1.0/kCTCoefficient))));
...
*/
const float kCTCorrFactorAntiLog = kCTCoefficient*log10(1.0 + kCTCorrFactorZero);
...
*/
const float kCTCorrFactorAntiLogScale = 1.0 / (-kCTCoefficient*log10(kCTCorrFactorZero) + kCTCorrFactorAntiLog);
