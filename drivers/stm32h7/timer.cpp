...
{{
    { TIM2, RCC_PERIPH_BUS(APB1L, TIM2), TIM2_IRQn, 15, UINT16_MAX, UINT16_MAX,
    { true, false, gpio::af::af1, { gpio::port::porta, gpio::pin::pin15 }}},

    { TIM3, RCC_PERIPH_BUS(APB1L, TIM3), TIM3_IRQn, 15, UINT16_MAX, UINT16_MAX,
    { true, false, gpio::af::af2, { gpio::port::portb, gpio::pin::pin4 }}},

    { TIM12, RCC_PERIPH_BUS(APB1L, TIM12), TIM8_BRK_TIM12_IRQn, 15, UINT16_MAX, UINT16_MAX,
