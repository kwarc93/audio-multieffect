...
void gpio::enable_clock(port port)
{
    ...
    {
        case port::porta:
            bus = RCC_PERIPH_BUS(AHB4, GPIOA);
            break;
        case port::portb:
            bus = RCC_PERIPH_BUS(AHB4, GPIOB);
            break;
        case port::portc:
            bus = RCC_PERIPH_BUS(AHB4, GPIOC);
            break;
        case port::portd:
            bus = RCC_PERIPH_BUS(AHB4, GPIOD);
            break;
        case port::porte:
            bus = RCC_PERIPH_BUS(AHB4, GPIOE);
            break;
        case port::portf:
            bus = RCC_PERIPH_BUS(AHB4, GPIOF);
            break;
        case port::portg:
            bus = RCC_PERIPH_BUS(AHB4, GPIOG);
            break;
        case port::porth:
            bus = RCC_PERIPH_BUS(AHB4, GPIOH);
            break;
        case port::porti:
            bus = RCC_PERIPH_BUS(AHB4, GPIOI);
            break;
        case port::portj:
            bus = RCC_PERIPH_BUS(AHB4, GPIOJ);
            break;
        case port::portk:
            bus = RCC_PERIPH_BUS(AHB4, GPIOK);
            break;
        default:
            return;
    }
