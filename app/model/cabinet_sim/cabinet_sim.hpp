...
private:
    ...
    constexpr static uint32_t ir_size {static_cast<uint32_t>(ir_res) - config::dsp_buffer_size};

    /* FFT based convolution */
    libs::adsp::fast_convolution<config::dsp_buffer_size, ir_size> fast_conv;
