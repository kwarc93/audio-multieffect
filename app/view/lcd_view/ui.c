...
lv_obj_t * ui_lbl_sett_main_in_vol;
lv_obj_t * ui_lbl_sett_aux_in_vol;
lv_obj_t * ui_lbl_sett_out_vol;
...
lv_obj_t * ui_bar_tuner_cents;
lv_obj_t * ui_bar_tuner_cents_indicator;
